export const hostelResults = [
  {
    ...
    rating: 4.5,
    reviewsCount: 1000,
    amenities: ["Wifi", "Single Room", "Food", "Laundry", "Bus Service", "Security"],
    mapCoords: { x: 45, y: 70 },
    ...
    detailedRoomTypes: [
      { name: "Twin Share AC", price: "₹2,25,000", frequency: "Per Annum" },
      { name: "Four Share", price: "₹1,26,500", frequency: "Per Annum" },
      { name: "Twin Share AC - Premium", price: "₹2,78,000", frequency: "Per Annum" },
      { name: "Triple Share AC - Premium", price: "₹2,17,500", frequency: "Per Annum" },
      { name: "Triple Share", price: "₹1,43,000", frequency: "Per Annum" },
      { name: "Five Share AC", price: "₹1,32,000", frequency: "Per Annum" },
      { name: "Six Share AC", price: "₹1,21,000", frequency: "Per Annum" },
    ]
  },
  {
    id: "HOSTEL-BLR-0001",
